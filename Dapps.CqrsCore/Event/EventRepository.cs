...
namespace Dapps.CqrsCore.Event
{
    ...
    public class EventRepository : IEventRepository
    {
        ...
        public async Task<T> GetAsync<T>(Guid id) where T : AggregateRoot
        {
        ...
        /// </summary>
        public IList<IEvent> Save<T>(T aggregate, int? version) where T : AggregateRoot
        {
        ...
        private async Task<T> RehydrateAsync<T>(Guid id) where T : AggregateRoot
        {
            // Get all the events for the id.
        ...
        public Task BoxAsync<T>(T aggregate) where T : AggregateRoot
        {
            throw new NotImplementedException();
        }

        public Task<T> UnboxAsync<T>(Guid aggregate) where T : AggregateRoot
        {
            throw new NotImplementedException();
        }
